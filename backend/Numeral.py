...
def get_degree(num):
   ...
   '''print("num_degree_milliard:" + str(num_degree_milliard))
   print("num_degree_million:" + str(num_degree_million))
   print("num_degree_thousand:" + str(num_degree_thousand))
   print("sum:" + str(sum))'''
